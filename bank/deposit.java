            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (p == pin) {
                        ...
                        JOptionPane.showMessageDialog(dep, "Amount Deposited Sucessfully");
                        new Interface();
                    } else {
                        JOptionPane.showMessageDialog(dep, "Invalid Pin");
                    }

                } catch (SQLException ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(dep, "Invalid Account Number");
                }
